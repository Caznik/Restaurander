                        ...
                        <AnimatePresence>
                            ...
                            <>
                                <motion.div
                                    ...
                                    animate={{ opacity: 1 }}
                                    exit={{ opacity: 0 }}
                                    className="absolute top-8 left-2 bg-red-500 text-white px-6 py-3 rounded-lg -rotate-12 border-4 border-white"
                                >
                                ...
                                <motion.div
                                    ...
                                    animate={{ opacity: 1 }}
                                    exit={{ opacity: 0 }}
                                    className="absolute top-8 right-2 bg-green-500 text-white px-6 py-3 rounded-lg rotate-12 border-4 border-white"
                                >
